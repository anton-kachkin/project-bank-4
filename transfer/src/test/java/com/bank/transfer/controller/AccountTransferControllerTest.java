...
class AccountTransferControllerTest {
    ...
    final Long id = 1L;
    final AccountTransferDto randomDto = DataGenerator.getRandomAccountDto();
    final AccountTransferDto dtoById = DataGenerator.getRandomAccountDtoWithId(id);
    ...
    void readAll_ReturnsValidResponseEntity() {
        ...
        var listDto = DataGenerator.getAccountTransferDtoList(ids);
    ...
    @Test
    @DisplayName("GET /read/{id} выбрасывает исключение EntityNotFoundException")
    void read_ThrowsEntityNotFoundException() {
    ...
    @Test
    @DisplayName("POST /create выбрасывает исключение при сохранении в репозиторий")
    ...
    @Test
    @DisplayName("PUT /update/{id} выбрасывает исключение EntityNotFoundException")
