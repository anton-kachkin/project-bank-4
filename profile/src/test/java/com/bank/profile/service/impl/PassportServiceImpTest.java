...
@DisplayName("Тестирование сервиса PassportServiceImp")
class PassportServiceImpTest {
    ...
    void setUp() {
        ...
        entity = entityFactory.createPassportEntity();
    ...
    void testFindById() {
        ...
        PassportDto result = service.findById(id);
    ...
    void testUpdate() {
        ...
        PassportDto result = service.update(id, dto);
    ...
    void testFindAllById() {
        ...
        List<PassportDto> resultList = service.findAllById(idList);
