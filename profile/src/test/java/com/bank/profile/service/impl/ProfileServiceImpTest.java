...
@DisplayName("Тестирование сервиса ProfileServiceImp")
class ProfileServiceImpTest {
    ...
    void setUp() {
        ...
        entity = entityFactory.createProfileEntity();
    ...
    void testUpdate() {
        ...
        ProfileDto result = service.update(id, dto);
    ...
    void testFindAllById() {
        ...
        List<ProfileDto> resultList = service.findAllById(idList);
